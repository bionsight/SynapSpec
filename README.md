...
- **Windows (GPU)**: `SynapSpec-windows-0.4.1.msi`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.4.1.msi`
- **Linux (GPU)**: `SynapSpec-linux-0.4.1.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.4.1.tar.gz`
- **macOS**: `SynapSpec-macos-0.4.1.dmg`
