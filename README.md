...
- **Windows (GPU)**: `SynapSpec-windows-0.10.4.zip`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.10.4.zip`
- **Linux (GPU)**: `SynapSpec-linux-0.10.4.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.10.4.tar.gz`
- **macOS**: `SynapSpec-macos-0.10.4.dmg`
