...
- **Windows (GPU)**: `SynapSpec-windows-0.4.2.msi`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.4.2.msi`
- **Linux (GPU)**: `SynapSpec-linux-0.4.2.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.4.2.tar.gz`
- **macOS**: `SynapSpec-macos-0.4.2.dmg`
