...
- **Windows (GPU)**: `SynapSpec-windows-0.9.1.zip`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.9.1.zip`
- **Linux (GPU)**: `SynapSpec-linux-0.9.1.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.9.1.tar.gz`
- **macOS**: `SynapSpec-macos-0.9.1.dmg`
