...
- **Windows (GPU)**: `SynapSpec-windows-0.9.2.zip`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.9.2.zip`
- **Linux (GPU)**: `SynapSpec-linux-0.9.2.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.9.2.tar.gz`
- **macOS**: `SynapSpec-macos-0.9.2.dmg`
