...
- **Windows (GPU)**: `SynapSpec-windows-0.10.0.zip`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.10.0.zip`
- **Linux (GPU)**: `SynapSpec-linux-0.10.0.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.10.0.tar.gz`
- **macOS**: `SynapSpec-macos-0.10.0.dmg`
