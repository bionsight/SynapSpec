...
- **Windows (GPU)**: `SynapSpec-windows-0.6.0.msi`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.6.0.msi`
- **Linux (GPU)**: `SynapSpec-linux-0.6.0.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.6.0.tar.gz`
- **macOS**: `SynapSpec-macos-0.6.0.dmg`
