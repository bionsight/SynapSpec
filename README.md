...
- **Windows (GPU)**: `SynapSpec-windows-0.10.1.zip`
- **Windows (CPU)**: `SynapSpec-windows-cpu-0.10.1.zip`
- **Linux (GPU)**: `SynapSpec-linux-0.10.1.tar.gz`
- **Linux (CPU)**: `SynapSpec-linux-cpu-0.10.1.tar.gz`
- **macOS**: `SynapSpec-macos-0.10.1.dmg`
