  ...
  return (
    <div className={container}>
      <div className="pt-10 pb-6 md:pt-16 md:pb-8">
        ...
        <h1 className="mt-3 text-[30px] tracking-[-0.035em] md:text-[40px]">Advanced proteomics software</h1>
        <p className="mt-3 max-w-[46ch] text-[15.5px] text-ink-600 md:text-[17px]">
          Comprehensive software for advanced mass spectrometry data analysis.
        </p>
      </div>

      <section className={block}>
        <SectionHead title="Core features">
          Powerful analytical capabilities for modern proteomics research.
        </SectionHead>
